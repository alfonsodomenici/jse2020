...
@NamedQueries({
     @NamedQuery(name = Categories.FIND_ALL, query = "select e from Categories e ORDER BY e.categoryName")   ,
})
public class Categories implements Serializable {
    ...
    public String toString() {
        return "it.tss.jpa.entities.Categories[ categoryID=" + categoryID + " ]";
    }
